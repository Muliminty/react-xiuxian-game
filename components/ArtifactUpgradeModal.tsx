...
import { X, Hammer, ArrowRight, Shield, Zap, Heart, Plus, Minus, Sparkles } from 'lucide-react';
...
interface Props {
  ...
  item: Item | null;
  player: PlayerStats;
  onConfirm: (item: Item, costStones: number, costMats: number, upgradeStones: number) => Promise<'success' | 'failure' | 'error'>;
  setItemActionLog?: (log: { text: string; type: string } | null) => void;
}

const ArtifactUpgradeModal: React.FC<Props> = ({ isOpen, onClose, item, player, onConfirm, setItemActionLog }) => {
